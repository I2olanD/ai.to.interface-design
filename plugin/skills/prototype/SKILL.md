...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Next.js          | `<Script src="https://ai-to-design.com/prototype.min.js" integrity="sha384-AO+HioGDSWzoCpTyDSD9J8CkFAL1MgoFeiweG21ZP1qj2VlW4qsP22VydYyl54um" crossOrigin="anonymous" strategy="afterInteractive" />` (import from `next/script`)   |
| React (Vite/CRA) | `<script src="https://ai-to-design.com/prototype.min.js" integrity="sha384-AO+HioGDSWzoCpTyDSD9J8CkFAL1MgoFeiweG21ZP1qj2VlW4qsP22VydYyl54um" crossorigin="anonymous"></script>` in `index.html`, or use a `useEffect` to inject it |
| Vue/Svelte/Astro | `<script src="https://ai-to-design.com/prototype.min.js" integrity="sha384-AO+HioGDSWzoCpTyDSD9J8CkFAL1MgoFeiweG21ZP1qj2VlW4qsP22VydYyl54um" crossorigin="anonymous"></script>` in the component or page                           |
| Plain HTML       | `<script src="https://ai-to-design.com/prototype.min.js" integrity="sha384-AO+HioGDSWzoCpTyDSD9J8CkFAL1MgoFeiweG21ZP1qj2VlW4qsP22VydYyl54um" crossorigin="anonymous"></script>` before `</body>`                                   |
